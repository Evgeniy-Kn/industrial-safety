...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if intersection_result == 1:
                ...
                cv2.putText(frame, 'Опасности нет', (50, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 0), 2, cv2.LINE_AA)
    ...
    frame = cv2.rectangle(frame, (rectangle_2[0], rectangle_2[1]), (rectangle_2[0] + rectangle_2[2], rectangle_2[1] + rectangle_2[3]), (0, 255, 0),
                          thickness=2, lineType=8, shift=0)
    frame = cv2.rectangle(frame, (rectangle_3[0], rectangle_3[1]), (rectangle_3[0] + rectangle_3[2], rectangle_3[1] + rectangle_3[3]), (255, 0, 0),
                          thickness=2, lineType=8, shift=0)
